...
int main()
{
	...
	peter_image = vita2d_load_PNG_buffer(&_binary_peter_png_start);
	...
	while (1) {
		...
		vita2d_draw_texture(peter_image, 20, 20);
		


		vita2d_draw_line(500, 30, 800, 300, RGBA8(255, 0, 255, 255));

		vita2d_pgf_draw_text(pgf, 700, 30, RGBA8(0,255,0,255), 1.0f, "Peter Griffen");
	...
	vita2d_free_texture(peter_image);
	vita2d_free_pgf(pgf);
	vita2d_free_pvf(pvf);
